...
module ActiveEntity
  ...
  module Inheritance
    ...
    module ClassMethods
      ...
      # Sets the application record class for Active Entity
      #
      ...
      # will share a database connection with Active Entity. It is the class
      # that connects to your primary database.
      def primary_abstract_class
        if ActiveEntity.application_entity_class && ActiveEntity.application_entity_class.name != name
          raise ArgumentError, "The `primary_abstract_class` is already set to #{ActiveEntity.application_entity_class.inspect}. There can only be one `primary_abstract_class` in an application."
        end

        self.abstract_class = true
        ActiveEntity.application_entity_class = self
      end
    ...
    private
      ...
      def ensure_proper_type
        klass = self.class
        if _has_attribute?(klass.inheritance_column)
