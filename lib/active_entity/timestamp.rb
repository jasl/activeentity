...
module ActiveEntity
  # = Active Entity \Timestamp
  #
  # Active Entity automatically timestamps create and update operations if the
  # table has fields named <tt>created_at/created_on</tt> or
  # <tt>updated_at/updated_on</tt>.
  #
  # Timestamping can be turned off by setting:
  #
  #   config.active_entity.record_timestamps = false
  #
  # Timestamps are in UTC by default but you can use the local timezone by setting:
  #
  #   config.active_entity.default_timezone = :local
  #
  # == Time Zone aware attributes
  #
  # Active Entity keeps all the <tt>datetime</tt> and <tt>time</tt> columns
  ...
  #
  #   config.active_entity.time_zone_aware_attributes = false
  #
  # You can also specify that only <tt>datetime</tt> columns should be time-zone
  # aware (while <tt>time</tt> should not) by setting:
  #
  #   ActiveEntity::Base.time_zone_aware_types = [:datetime]
  #
  # You can also add database specific timezone aware types. For example, for PostgreSQL:
  #
  #   ActiveEntity::Base.time_zone_aware_types += [:tsrange, :tstzrange]
  #
  ...
  module Timestamp
    ...
    module ClassMethods # :nodoc:
      ...
      def current_time_from_proper_timezone
        ActiveEntity.default_timezone == :utc ? Time.now.utc : Time.now
      end
