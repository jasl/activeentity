...
module ActiveEntity
  module Integration
    ...
    #
    # If ActiveEntity::Base.cache_versioning is turned off, as it was in Rails 5.1 and earlier,
    ...
    #
    # Note, this method will return nil if ActiveEntity::Base.cache_versioning is set to
    # +false+.
    def cache_version
